      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I am an Air Force veteran, web developer who builds responsive web
            applications and brings ideas to features. Looking to grow as a
            developer who leads large scale projects while delivering
            exceptional performance and amazing user experiences.
          </p>
